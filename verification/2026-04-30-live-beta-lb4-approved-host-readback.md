...
PR #20 P1 review fix checks:

- Venue-state regression: `sampling_markets_derive_trading_enabled_from_accepting_orderbook_market` confirms the read-only sampling-market signal can produce `trading_enabled`.
