...
- Next exit gate: human review of PR #34 after the approval-binding, approval-reuse, live-submit gate, post-acceptance cleanup, primary cancel retry, duration-cap, filled-terminal reconciliation, and close-window TTL runway hardening commits; merge only after review is satisfied. Do not start LA6; LA6 remains on hold until a separate post-LA5 review and explicit phase approval.
